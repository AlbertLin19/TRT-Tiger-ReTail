...
urlpatterns = [
    ...
    path("admin/flags/manage/", views.adminManageFlags, name="manage_flags"),
    path("admin/flags/item/<int:pk>/delete/", views.adminDeleteItemFlag, name="delete_item_flag"),
    path("admin/flags/item_request/<int:pk>/delete/", views.adminDeleteItemRequestFlag, name="delete_item_request__flag"),
